-- Query for the KPIs in SS: MQL/Signups/Demo Requests/Visits/Activated/Newlogos/PayingCustomers/MRR/ASP
...
where af.lead_mql_date >= '2022-01-01' and af.won_opportunity_self_serve_flag = TRUE
group by 1
order by 1 desc),
